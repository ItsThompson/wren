...
# Server-minted slug prefixes, one per child entity.
...
# Server-set page size for the paginated section drill-down (the server sets the
# page size; the client pages with an opaque cursor). Injected
